  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M5.25 2.25C5.25 1.83579 5.58579 1.5 6 1.5H12C12.4142 1.5 12.75 1.83579 12.75 2.25V4.5H14.25C15.4926 4.5 16.5 5.50736 16.5 6.75V11.25C16.5 11.6642 16.1642 12 15.75 12H12.75V15.75C12.75 16.1642 12.4142 16.5 12 16.5H6C5.58579 16.5 5.25 16.1642 5.25 15.75V12H2.25C1.83579 12 1.5 11.6642 1.5 11.25V6.75C1.5 5.50736 2.50736 4.5 3.75 4.5H5.25V2.25ZM6.75 4.5H11.25V3H6.75V4.5ZM6.75 15H11.25V10.5H6.75V15ZM12.75 10.5H15V6.75C15 6.33579 14.6642 6 14.25 6H3.75C3.33579 6 3 6.33579 3 6.75V10.5H5.25V9.75C5.25 9.33579 5.58579 9 6 9H12C12.4142 9 12.75 9.33579 12.75 9.75V10.5Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M4.5 1.5C3.67157 1.5 3 2.17157 3 3V15C3 15.8284 3.67157 16.5 4.5 16.5H13.5C14.3284 16.5 15 15.8284 15 15V6.62132C15 6.2235 14.842 5.84197 14.5607 5.56066L10.9393 1.93934C10.658 1.65803 10.2765 1.5 9.87868 1.5H4.5ZM4.5 3H9.75V6C9.75 6.41421 10.0858 6.75 10.5 6.75H13.5V15H4.5V3ZM11.25 5.25V3.31066L13.1893 5.25H11.25ZM5.25 10.5C5.25 10.0858 5.58579 9.75 6 9.75H7.5C8.74264 9.75 9.75 10.7574 9.75 12C9.75 13.2426 8.74264 14.25 7.5 14.25H6.75V15C6.75 15.4142 6.41421 15.75 6 15.75C5.58579 15.75 5.25 15.4142 5.25 15V10.5ZM6.75 12.75H7.5C7.91421 12.75 8.25 12.4142 8.25 12C8.25 11.5858 7.91421 11.25 7.5 11.25H6.75V12.75ZM10.5 10.5C10.5 10.0858 10.8358 9.75 11.25 9.75H12.75C13.1642 9.75 13.5 10.0858 13.5 10.5C13.5 10.9142 13.1642 11.25 12.75 11.25H12V12H12.75C13.1642 12 13.5 12.3358 13.5 12.75C13.5 13.1642 13.1642 13.5 12.75 13.5H12V15C12 15.4142 11.6642 15.75 11.25 15.75C10.8358 15.75 10.5 15.4142 10.5 15V10.5Z"
        fill="currentColor"
      />
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M12.75 3.75C12.75 2.50736 13.7574 1.5 15 1.5C16.2426 1.5 17.25 2.50736 17.25 3.75C17.25 4.99264 16.2426 6 15 6C14.5469 6 14.125 5.86605 13.7716 5.63552L6.83517 9.10375C6.86134 9.23157 6.875 9.36393 6.875 9.5C6.875 9.63607 6.86134 9.76843 6.83517 9.89625L13.7716 13.3645C14.125 13.1339 14.5469 13 15 13C16.2426 13 17.25 14.0074 17.25 15.25C17.25 16.4926 16.2426 17.5 15 17.5C13.7574 17.5 12.75 16.4926 12.75 15.25C12.75 15.1139 12.7637 14.9816 12.7898 14.8537L5.85342 11.3855C5.50002 11.6161 5.07806 11.75 4.625 11.75C3.38236 11.75 2.375 10.7426 2.375 9.5C2.375 8.25736 3.38236 7.25 4.625 7.25C5.07806 7.25 5.50002 7.38395 5.85342 7.61448L12.7898 4.14625C12.7637 4.01843 12.75 3.88607 12.75 3.75ZM15 3C14.5858 3 14.25 3.33579 14.25 3.75C14.25 4.16421 14.5858 4.5 15 4.5C15.4142 4.5 15.75 4.16421 15.75 3.75C15.75 3.33579 15.4142 3 15 3ZM4.625 8.75C4.21079 8.75 3.875 9.08579 3.875 9.5C3.875 9.91421 4.21079 10.25 4.625 10.25C5.03921 10.25 5.375 9.91421 5.375 9.5C5.375 9.08579 5.03921 8.75 4.625 8.75ZM15 14.5C14.5858 14.5 14.25 14.8358 14.25 15.25C14.25 15.6642 14.5858 16 15 16C15.4142 16 15.75 15.6642 15.75 15.25C15.75 14.8358 15.4142 14.5 15 14.5Z"
        fill="currentColor"
      />
    </svg>
  );
